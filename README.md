...
Because SpacePixels looks for tiny pixel movements between frames, it expects the background starfield to be highly stationary. SpacePixels is designed to use accurately aligned (registered) and calibrated FITS images as its input (e.g., intermediate files generated by DeepSkyStacker, Siril, or PixInsight).
...
* **Plate Solving:** Seamless integration with local **ASTAP** or online **Astrometry.net** to solve images and reliably write standard WCS coordinate solutions back into your FITS headers.
